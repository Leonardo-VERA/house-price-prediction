...
model_path = 'models/lightgbm_optimized_v2.pkl' 
...
# predire
prix_log = model.predict(new_maison)

#transformer en dolars
prix_reel = np.expm1(prix_log)[0]

print(f"\n💰 ESTIMATION DE PRIX DE VENTE: ${prix_reel:,.2f}")